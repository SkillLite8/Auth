...
func main() {
	...
	fmt.Println("║     🛸  NeverTime RESOURCE PACK Dumper v5.2 (Bypass) ║")
	...
	// Используем login.ClientData из правильного подпакета
	...
	for i, pack := range packs {
		...
		// Читаем данные пака через io.ReadAll, так как объект реализует io.Reader
